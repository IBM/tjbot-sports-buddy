...
* Build a TJBot that converses using Watson Assistant for Business
...
* [Watson Assistant for Business](https://www.ibm.com/watson/developercloud/conversation.html): Build, test and deploy a bot or virtual agent across mobile devices, messaging platforms, or even on a physical robot.
...
3. [Configure Watson Assistant for Business](#3-configure-watson-conversation)
...
## 3. Configure Watson Assistant for Business
...
- *Watson Assistant for Business:* The conversation flow.
